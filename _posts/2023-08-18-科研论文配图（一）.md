...
![](img/attachments/Pasted%20image%2020230817185417.jpg)
...
![](img/attachments/Pasted%20image%2020230817185505.jpg)
...
![](img/attachments/Pasted%20image%2020230817185514.jpg)
...
![](img/attachments/Pasted%20image%2020230817185529.jpg)
...
![](img/attachments/Pasted%20image%2020230817185539.jpg)
#### 1. 单配色方案
...
![](img/attachments/Pasted%20image%2020230817185603.jpg)
#### 3. 多色系
...
![](img/attachments/Pasted%20image%2020230817185633.jpg)
#### 3. ColorBrewer 2.0
...
⑧ 展示不同颜色搭配方案的预览效果。
![](img/attachments/Pasted%20image%2020230817185651.jpg)

# 1.3 实操
## 1.3.1 折线图绘制
![](img/attachments/Pasted%20image%2020230817185700.jpg)
```python
...
```
## 1.3.2 直方图
![](img/attachments/Pasted%20image%2020230817185713.jpg)
```python
menMeans  = (5, 15, 30, 40
menStd   = (2, 3, 4, 5)
ind  = np.arange(4)
...
plt.show()
```
![](img/attachments/Pasted%20image%2020230817185722.jpg)

## 1.3.4 小提琴图
- 中位数（小提琴图上的一个白点)
- 四分位数范围（小提琴中心的黑色条）。
- 较低/较高的相邻值（黑色条形图）--分别定义为第一四分位数-1.5 IQR和第三四分位数+1.5 IQR。这些值可用于简单的离群值检测技术,即位于这些 "栅栏"之外的值可被视为离群值。![](img/attachments/Pasted%20image%2020230817185731.jpg)
...
plt.show()
```
![](img/attachments/Pasted%20image%2020230817185742.jpg)
![](img/attachments/Pasted%20image%2020230817185756.jpg)
![](img/attachments/Pasted%20image%2020230817185807.jpg)
...
plt.show()
```
![](img/attachments/Pasted%20image%2020230817185817.jpg)
![](img/attachments/Pasted%20image%2020230817185832.jpg)
![](img/attachments/Pasted%20image%2020230817185843.jpg)
# 1.4 总结
